                        ...
                        <label for="">Nama Dusun</label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" readonly name="laki" id="laki" value="0" class="form-control" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label for="perempuan">Perempuan</label>
                                    <input type="number" readonly name="perempuan" id="perempuan" value="0" class="form-control" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label for="perempuan">Total</label>
                                    <input type="number" readonly name="total" id="total" value="0" class="form-control" class="form-control">
                                </div>
                            </div>
                        </div>
