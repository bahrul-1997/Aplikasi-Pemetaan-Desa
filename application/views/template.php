...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('dashboard') ?>">
        ...
        <div class="sidebar-brand-text mx-3">Kacamata<sup>KU</sup></div>
      </a>
      ...
      <?php if ($this->session->userdata('level') == 1) { ?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url('desa') ?>">
            ...
            <span>Pemetaan Desa</span></a>
        </li>

        <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#penjualan" aria-expanded="true" aria-controls="collapseUtilities">
          <i class="fas fa-fw fa-cart-plus"></i>
          <span>Data Desa</span>
        </a>
        <div id="penjualan" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-primary py-2 collapse-inner rounded">
            <a class="collapse-item " href="<?=base_url('data_desa')?>">Desa</a>
            <a class="collapse-item" href="<?=base_url('dusun')?>">Dusun</a>
          </div>
        </div>
      </li>
      <?php } ?>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Pemetaan Desa Alastengah 2021</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script src="<?= base_url(); ?>/assets/js/validasi/desa.js"></script>
  <script src="<?= base_url(); ?>/assets/js/validasi/dusun.js"></script>
